...
import { Info, Bitcoin, Activity, ArrowUpRight } from "lucide-react";
...
// Mock Data for Area Chart (Crypto Price Delta)
const data = [
    { time: 'T-0 (Entry)', price: 42000, color: '#8B5CF6' },
    { time: 'Q1', price: 45000 },
    { time: 'Q2', price: 41000 },
    { time: 'Q3', price: 58000 },
    { time: 'T-1 (Now)', price: 68500, color: '#10B981' },
];
...
export default function CryptoROICalculator() {
    return (
        <div className="min-h-screen relative overflow-hidden bg-gradient-to-b from-[#090B14] to-black">
            {/* Ambient Deep Space Grid & Volumetric Glows (Violet hue for digital assets) */}
            ...
            <div className="relative border-b border-white/[0.04] py-16 backdrop-blur-sm z-10">
                <div className="container mx-auto px-4 max-w-7xl relative z-10">
                    <div className="flex items-center gap-4 mb-6">
                        ...
                        <h1 className="text-4xl md:text-5xl lg:text-7xl font-black text-white tracking-tighter drop-shadow-lg">Digital Asset ROI Matrix.</h1>
                    </div>
                    <p className="text-slate-400 max-w-2xl font-light leading-relaxed">
                        High-volatility returns engine. Track quantitative appreciation, total profit deltas, and absolute multiplier curves.
                    </p>
                </div>
            </div>
                    ...
                    <div className="lg:col-span-4 relative z-10">
                        <Card className="bg-gradient-to-b from-white/[0.03] to-transparent h-full border-t border-violet-500/10">
                            ...
                            <h2 className="text-xs font-bold text-violet-400 uppercase tracking-widest mt-2 mb-6 border-b border-white/[0.04] pb-4 flex items-center gap-2">
                                <Activity className="w-4 h-4" /> Market Data Feed
                            </h2>

                            <Input label="Asset Ticker" value="BTC" bg="bg-black/40" />
                            <Input label="Initial Investment Capital" value="10,000" prefix="$" bg="bg-black/40" />

                            <h2 className="text-[10px] font-bold text-violet-400 uppercase tracking-widest mt-8 mb-6 border-b border-white/[0.04] pb-4">
                                Pricing Deltas
                            </h2>

                            <Input label="Entry (Purchase Price)" value="42,000" prefix="$" bg="bg-black/40" />
                            <Input label="Current Market Price" value="68,500" prefix="$" bg="bg-white/[0.02] text-slate-400" />
                            ...
                            <button className="relative z-10 w-full bg-violet-600/90 text-white py-4 mt-8 text-sm font-bold tracking-wide hover:bg-violet-500 transition-colors shadow-[0_0_20px_rgba(139,92,246,0.2)] rounded-lg flex items-center justify-center gap-2">
                                RECALCULATE RETURN DELTA <ArrowUpRight className="w-4 h-4" />
                            </button>
                        </Card>
                    </div>
                    ...
                    <div className="lg:col-span-8 flex flex-col gap-8 relative z-10">
                        ...
                        <div className="bg-[#05060A]/80 border border-violet-500/20 p-8 sm:p-12 relative overflow-hidden rounded-2xl shadow-[0_0_40px_rgba(139,92,246,0.1)] backdrop-blur-3xl">
                            ...
                            <div className="relative z-10 grid md:grid-cols-2 gap-12 items-end">
                                <div>
                                    <h3 className="text-slate-400 text-xs tracking-widest uppercase font-medium mb-4">Total Net Return</h3>
                                    <div className="text-6xl sm:text-7xl font-mono font-bold text-white tracking-tighter drop-shadow-2xl">
                                        <span className="text-4xl text-emerald-400 mr-1">+</span>63<span className="text-3xl text-emerald-400">.10%</span>
                                    </div>
                                    <p className="text-[10px] font-mono mt-4 text-emerald-400/80 uppercase tracking-widest bg-emerald-500/10 inline-block px-2 py-1 rounded">Asset Outperforming Market</p>
                                </div>
                                <div className="space-y-6 border-t md:border-t-0 md:border-l border-white/[0.04] pt-8 md:pt-0 md:pl-12">
                                    <div className="bg-[#05060A]/90 backdrop-blur-xl p-6 rounded-xl border border-white/[0.04] shadow-inner mb-4">
                                        <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-2">Total Current Value</p>
                                        <p className="text-3xl font-mono text-white">$16,309<span className="text-lg text-slate-500">.52</span></p>
                                    </div>
                                    <div className="bg-[#05060A]/90 backdrop-blur-xl p-6 rounded-xl border border-emerald-500/20 shadow-[0_0_20px_rgba(16,185,129,0.1)]">
                                        <p className="text-[10px] font-bold text-emerald-400 uppercase tracking-widest mb-2">Total Profit Yield</p>
                                        <p className="text-3xl font-mono text-emerald-400">+$6,309<span className="text-lg text-emerald-400/50">.52</span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-white/[0.04] border border-white/[0.04] rounded-2xl overflow-hidden shadow-2xl">
                            <div className="bg-[#05060A]/90 backdrop-blur-xl p-6 hover:bg-white/[0.02] transition-colors group">
                                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-4">Quantity Held</p>
                                <p className="text-xl font-mono text-white group-hover:text-violet-300 transition-colors">0.2381 <span className="text-sm font-sans tracking-tight text-slate-500">BTC</span></p>
                            </div>
                            <div className="bg-[#05060A]/90 backdrop-blur-xl p-6 hover:bg-white/[0.02] transition-colors group">
                                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-4">Cost Basis</p>
                                <p className="text-xl font-mono text-slate-300 transition-colors">$42,000</p>
                            </div>
                            <div className="bg-[#05060A]/90 backdrop-blur-xl p-6 hover:bg-white/[0.02] transition-colors group">
                                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-4">Fiat Multiple</p>
                                <p className="text-xl font-mono text-white group-hover:text-emerald-300 transition-colors">1.63x</p>
                            </div>
                            <div className="bg-[#05060A]/90 backdrop-blur-xl p-6 hover:bg-white/[0.02] transition-colors group">
                                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-4">Risk Profile</p>
                                <p className="text-xl font-mono text-rose-400 transition-colors tracking-tighter">HIGH</p>
                            </div>
                        </div>
                        ...
                        <Card>
                            <div className="flex items-center justify-between mb-8 pb-4 border-b border-white/[0.04]">
                                <h3 className="text-sm font-bold text-white uppercase tracking-widest flex items-center gap-2">
                                    Asset Pricing Trajectory
                                    <Info className="w-4 h-4 text-slate-500" />
                                </h3>
                                <div className="flex gap-4">
                                    <div className="flex items-center gap-2 text-[10px] uppercase font-bold text-slate-400"><div className="w-2 h-2 bg-violet-400 rounded-full shadow-[0_0_8px_rgba(139,92,246,0.5)]"></div> Market Price</div>
                                </div>
                            </div>
                            <div className="h-[250px] w-full mt-4">
                                <ResponsiveContainer width="100%" height="100%" minWidth={1} minHeight={1} aspect={undefined}>
                                    <AreaChart data={data} margin={{ top: 10, right: 0, left: 0, bottom: 0 }}>
                                        <XAxis dataKey="time" axisLine={false} tickLine={false} tick={{ fontSize: 12, fill: '#64748b' }} dy={10} minTickGap={2} />
                                        ...
                                        />
                                        <Area type="monotone" dataKey="price" stroke="#8B5CF6" strokeWidth={3} fill="#8B5CF6" fillOpacity={0.15} />
                                    </AreaChart>
                                </ResponsiveContainer>
                            </div>
                        </Card>
