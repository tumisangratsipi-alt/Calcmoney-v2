                ...
                <div className="container mx-auto px-4 max-w-7xl relative z-10">
                    <div className="flex items-center gap-6 mb-8">
                        <div className="w-14 h-14 bg-white/[0.02] border border-white/[0.05] rounded-xl flex items-center justify-center shadow-inner shadow-white/5 relative overflow-hidden">
                            ...
                            <Image src="/images/icons/calcmoney_icon_budget.png" alt="Business Valuation" width={28} height={28} className="relative z-10" />
                        </div>
                        <h1 className="text-4xl md:text-6xl font-black text-white tracking-tighter drop-shadow-2xl">Enterprise Valuation.</h1>
                    </div>
                ...
                <div className="grid lg:grid-cols-12 gap-8 lg:gap-12">
                    ...
                    <div className="lg:col-span-4 space-y-8 relative z-10">
                        <Card className="bg-gradient-to-b from-white/[0.03] to-transparent">
                            ...
                            <h2 className="text-[10px] font-bold text-blue-400 uppercase tracking-widest mb-6 border-b border-white/[0.04] pb-4 relative z-10">P&L Data</h2>
                            <Input label="LTM Revenue" value="1,200,000" prefix="$" bg="bg-black/40" />
                            <Input label="LTM Adjusted EBITDA" value="350,000" prefix="$" bg="bg-black/40" />

                            <h2 className="text-[10px] font-bold text-blue-400 uppercase tracking-widest mb-6 mt-8 border-b border-white/[0.04] pb-4 relative z-10">Market Multiples</h2>
                            <Input label="Industry Average Multiple (x) " value="4.5" suffix="x" bg="bg-black/40" />
                            ...
                            <div className="relative z-10 grid md:grid-cols-3 gap-8 items-end">
                                <div className="md:col-span-2">
                                    <p className="text-[10px] font-bold text-blue-400 uppercase tracking-widest mb-6 flex items-center gap-3 border-b border-white/[0.04] pb-4">
                                        ...
                                        Absolute Enterprise Value
                                    </p>
                                    <h3 className="text-slate-500 text-xs tracking-widest uppercase font-medium mb-3">Estimated Market Clearing Price</h3>
                                    <div className="text-5xl sm:text-7xl font-mono text-white tracking-tighter drop-shadow-2xl">$1,575,000</div>
                                </div>
                                <div className="pt-6 md:pt-0 border-t md:border-t-0 md:border-l border-white/[0.04] md:pl-8">
                                    <h3 className="text-blue-200/50 text-xs font-bold uppercase tracking-widest mb-3 mt-1">EBITDA Margin</h3>
                                    <div className="text-4xl sm:text-5xl font-mono text-blue-400 tracking-tight drop-shadow-md">29.1<span className="text-2xl text-blue-600/50">%</span></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <Card>
                            ...
                            <div className="space-y-4">
                                <div className="flex justify-between items-center py-3 border-b border-white/[0.04]">
                                    <span className="text-slate-400 font-light">EBITDA Multiple Applied</span>
                                    <span className="font-mono text-white">4.5x</span>
                                </div>
                                <div className="flex justify-between items-center py-3 border-b border-white/[0.04]">
                                    <span className="text-slate-400 font-light text-blue-400">Revenue Multiple Equivalent</span>
                                    <span className="font-mono text-blue-400">1.31x</span>
                                </div>
                                <div className="flex justify-between items-center py-3">
                                    <span className="text-slate-400 font-light text-emerald-400">Projected Valuation</span>
                                    <span className="font-mono text-emerald-400 text-lg tracking-tight">$1.57M</span>
                                </div>
                            </div>
                        </Card>
